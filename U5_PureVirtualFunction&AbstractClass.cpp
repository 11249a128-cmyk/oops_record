...
Algorithm:
        Step 1 : Create Shape with pure virtual area().
        Step 2 : Create derived classes and implement area().
        Step 3 : Use Shape* to refer to each derived object and display area.
