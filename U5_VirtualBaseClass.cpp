...
Algorithm:
        Step 1 : Student with common data.
        Step 2 : Test and Sports virtually inherit from Student.
        Step 3 : Result inherits Test and Sports, collects marks and sport score, and computes total.
